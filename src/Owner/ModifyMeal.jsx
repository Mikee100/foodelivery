...
const ModifyMeal = () => {
  ...
  const fetchMealDetails = async () => {
    try {
      const response = await axios.get(`http://192.168.158.75:3000/api/meals/${mealId}`);
  ...
  const fetchCategories = async () => {
    ...
    try {
      const response = await axios.get(`http://192.168.158.75:3000/api/restaurants/${restaurantId}/categories`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`http://192.168.158.75:3000/api/updatemeals/${mealId}`, updatedMeal, {
