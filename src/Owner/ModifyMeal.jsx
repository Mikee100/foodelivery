...
const ModifyMeal = () => {
  ...
  const fetchMealDetails = async () => {
    try {
      const response = await axios.get(`http://roundhouse.proxy.rlwy.net:3000/api/meals/${mealId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`http://roundhouse.proxy.rlwy.net:3000/api/updatemeals/${mealId}`, updatedMeal, {
